  ...
  return (
    <div className="space-y-6">
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-widest text-amber-200/50 mb-3">What's included</p>
        ...
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-widest text-amber-200/50 mb-3">Not included</p>
          <ul className="space-y-2">
      ...
      {notes.length > 0 && (
        <div className="rounded-xl border border-amber-400/20 bg-amber-400/[0.06] p-4">
          <p className="text-[11px] font-semibold uppercase tracking-widest text-amber-300/80 mb-2">Important notes</p>
