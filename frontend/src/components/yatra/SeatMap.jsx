              ...
              .map((seat) => {
                ...
                return (
                  <button
                    ...
                    onClick={() => toggle(seat.seatId, state)}
                    aria-label={`${seat.label} ${state}`}
                    className={`h-10 w-12 sm:w-14 rounded-lg border text-xs font-semibold transition ${
                      state === "selected"
                        ? "bg-amber-300 text-black border-amber-100"
                        : state === "available"
                        ? "text-amber-50 border-amber-200/25 hover:border-amber-200 hover:bg-amber-300/10"
                        : state === "booked"
